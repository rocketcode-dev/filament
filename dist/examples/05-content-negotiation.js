...
function toHTML(data, title = 'Data') {
    if (!data.length)
...
app.use(async (req, res, next) => {
    ...
    if (formatParam && supportedFormats.includes(formatParam)) {
        requestedFormat = formatParam;
    }
...
//# sourceMappingURL=05-content-negotiation.js.map