...
app.get('/api/v1/user/:id', { apiVersion: 'v1', deprecated: true, responseFormat: 'minimal' }, async (req, res) => {
...
app.get('/api/v1/user/:id/profile', { apiVersion: 'v1', deprecated: true, responseFormat: 'standard' }, async (req, res) => {
    // V1 profile format
    res.json({
        user: {
            id: userData.id,
...
app.get('/api/v2/user/:id', { apiVersion: 'v2', responseFormat: 'standard' }, async (req, res) => {
...
app.get('/api/v2/user/:id/full', { apiVersion: 'v2', responseFormat: 'detailed' }, async (req, res) => {
